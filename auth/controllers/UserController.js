...
exports.register = function (req, res) {
  const { name,username, email, password, passwordConfirmation, contactNumber, address } = req.body
  if (!email || !password) {
  ...
  User.findOne({ email }, function (err, existingUser) {
    ...
    if (existingUser) {
      ...
      const user = new User({
        name,username, email, password, passwordConfirmation, contactNumber, address
      })
